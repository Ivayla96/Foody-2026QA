...
namespace Foody
{
    public class FoodyTests
    {
        ...
        private static string foodId; //id Ì‡ ı‡Ì‡Ú‡, ÍÓˇÚÓ ÒÏÂ Ò˙Á‰‡ÎË ‚ ÚÂÒÚ 1

        [OneTimeSetUp] //¬≈ƒÕ⁄∆ √Œ  ŒÕ‘»√”–»–¿Ã≈ œ–≈ƒ» œ”— ¿Õ≈“Œ Õ¿ ¬—»◊ » “≈—“Œ¬≈
        public void Setup()
        {
            string jwtToken = GetJwtToken("2026BEE", "2026BE");
